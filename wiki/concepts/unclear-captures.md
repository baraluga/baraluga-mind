...
Some source captures are too sparse or ambiguous to convert into durable project notes. They are kept as sources so the original evidence remains available, but no facts should be inferred from them.
