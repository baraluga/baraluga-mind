...
- The same standup reported `SCR-1219` ready for validation once weekly-capacity runs were confirmed green in QA and production. It also recorded a simplified historical scope for the related backfill discussion: OCCTO data through fiscal 2025, with Bloomberg needed for fiscal 2024 onward under a different TSDB setup; the exact ticket mapping in the Granola summary is ambiguous.
